// Haryana Waterfalls Data
import { KarnatakaPOI } from '../../types/database';

export const kalesarData: KarnatakaPOI = {
  id: 'kalesar_haryana',
  name: 'Kalesar Falls',
  category: 'waterfall',
  coordinates: { lat: 30.3833, lng: 76.7833 },
  description: 'Beautiful waterfall near Ambala, popular among tourists.',
  icon_color: '#87CEEB',
  tabs: {
