...
export const tajewalaData: KarnatakaPOI = {
  id: 'tajewala_haryana',
  name: 'Tajewala Dam',
  category: 'dam',
  coordinates: { lat: 30.1333, lng: 77.2833 },
  description: 'Dam on the Yamuna River, important for irrigation and power generation.',
  icon_color: '#4682B4',
  tabs: {
    ...
    rivers_associated: { title: 'Rivers Associated', content: [{ title: 'Yamuna River', description: 'Built across the Yamuna River.', image_url: 'https://example.com/yamuna-river.jpg', links: [{ title: 'River Information', url: 'https://example.com/river-info' }] }] },
