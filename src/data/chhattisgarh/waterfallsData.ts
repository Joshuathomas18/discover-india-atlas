// Chhattisgarh Waterfalls Data
import { KarnatakaPOI } from '../../types/database';

export const chitrakoteData: KarnatakaPOI = {
  id: 'chitrakote_chhattisgarh',
  name: 'Chitrakote Falls',
  category: 'waterfall',
  coordinates: { lat: 19.0833, lng: 82.0333 },
  description: 'Beautiful waterfall in Chhattisgarh, popular among tourists.',
  icon_color: '#87CEEB',
  tabs: {
