...
export const bhakraNangalData: KarnatakaPOI = {
  id: 'bhakra_nangal_punjab',
  name: 'Bhakra Nangal Dam',
  category: 'dam',
  coordinates: { lat: 31.4167, lng: 76.4333 },
  description: 'Large dam on the Sutlej River, important for irrigation and power generation.',
  icon_color: '#4682B4',
  tabs: {
    ...
    rivers_associated: { title: 'Rivers Associated', content: [{ title: 'Sutlej River', description: 'Built across the Sutlej River.', image_url: 'https://example.com/sutlej-river.jpg', links: [{ title: 'River Information', url: 'https://example.com/river-info' }] }] },
...
export default [bhakraNangalData];
