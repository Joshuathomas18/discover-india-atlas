// Punjab Waterfalls Data
import { KarnatakaPOI } from '../../types/database';

export const chakkiData: KarnatakaPOI = {
  id: 'chakki_punjab',
  name: 'Chakki Falls',
  category: 'waterfall',
  coordinates: { lat: 30.7333, lng: 76.7794 },
  description: 'Beautiful waterfall near Chandigarh, popular among tourists.',
  icon_color: '#87CEEB',
  tabs: {
