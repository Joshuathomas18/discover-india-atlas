// Andhra Pradesh Waterfalls Data
import { KarnatakaPOI } from '../../types/database';

export const kailasakonaData: KarnatakaPOI = {
  id: 'kailasakona_andhra_pradesh',
  name: 'Kailasakona Falls',
  category: 'waterfall',
  coordinates: { lat: 13.6288, lng: 79.4192 },
  description: 'Beautiful waterfall near Tirupati, popular among tourists.',
  icon_color: '#87CEEB',
  tabs: {
...
export default [kailasakonaData];
