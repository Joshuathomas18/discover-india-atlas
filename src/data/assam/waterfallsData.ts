// Assam Waterfalls Data
import { KarnatakaPOI } from '../../types/database';

export const kakochangData: KarnatakaPOI = {
  id: 'kakochang_assam',
  name: 'Kakochang Falls',
  category: 'waterfall',
  coordinates: { lat: 26.7500, lng: 94.2167 },
  description: 'Beautiful waterfall near Jorhat, popular among tourists.',
  icon_color: '#87CEEB',
  tabs: {
