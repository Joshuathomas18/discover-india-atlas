// Jharkhand Waterfalls Data
import { KarnatakaPOI } from '../../types/database';

export const hundruData: KarnatakaPOI = {
  id: 'hundru_jharkhand',
  name: 'Hundru Falls',
  category: 'waterfall',
  coordinates: { lat: 23.3441, lng: 85.3096 },
  description: 'Beautiful waterfall in Jharkhand, popular among tourists.',
  icon_color: '#87CEEB',
  tabs: {
